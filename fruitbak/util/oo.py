...
class _getdelinitializer(_getinitializer):
    ...
    def __isabstractmethod__(self):
        return (
            getattr(self.delfunction, '__isabstractmethod__', False)
            or super().__isabstractmethod__
        )
...
class _getsetinitializer(_getinitializer):
    ...
    def __isabstractmethod__(self):
        return (
            getattr(self.setfunction, '__isabstractmethod__', False)
            or super().__isabstractmethod__
        )
...
class flexiblemethod:
    ...
    @property
    def __isabstractmethod__(self):
        return getattr(self._method, '__isabstractmethod__', False) or getattr(
            self._classmethod, '__isabstractmethod__', False
        )
