...
from fruitbak.util import NCondition, initializer
...
class LMDB(Storage):
    ...
    def _ensure_started(self):
        ...
        try:
            workers = [
                _Worker(cond, self.reads, self.writes, self.writing, self.env, done)
    ...
    def env(self):
        assert self.cond
        from lmdb import MemoryError, open as lmdb_open
